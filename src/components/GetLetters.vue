<template>
  <div id="word-soap-test" class="q-gutter-md col-10 q-pa-md">
    ...
    <q-form
      ...
      @submit="onSubmit"
      @reset="onReset"
      class="q-gutter-md words-soap-form row"
    >
      <div class="fila-1-form row col-12 q-gutter-md">
        <q-input
          class="col"
          filled
          v-model="columnas"
      ...
      <div class="fila-2-form row col-12 q-gutter-md">
      ...
      <div class="buttons-container col-12 row q-gutter-md">
        <q-btn class="col" label="Submit" type="submit" color="primary" />
        <q-btn label="Reset" type="reset" color="primary" flat class="col" />
      </div>
    </q-form>
    <div class="word-soap-results-container q-gutter-md row">
      <div
        v-if="filas != 0 && columnas != 0"
        class="word-soap-container q-gutter-md col-5"
      >
